...
const Collections = () => {
  ...
  const summaryClasses =
    "hover:text-white ml-5 font-semibold transition ease-in-out delay-100";
  const liClasses =
    "text-gray-500 hover:text-yellow-500 hover:text-base ml-6 text-sm transition ease-in-out delay-100";
